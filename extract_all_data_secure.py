...
def extract_all_data_safe():
    ...
    with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        while offset < total_count:
            ...
            if writer is None:
                fieldnames = [
                    'id_performance', 'id_course', 'nom_norm', 'annee', 
                    'position_arrivee', 'victoire', 'place', 'numero_corde',
                    'cote_sp', 'distance', 'discipline', 'nombre_partants',
                    'hippodrome_nom', 'driver_jockey', 'entraineur',
                    'date_course', 'sexe', 'age'
                ]
