...
from enrichment.matching import HorseMatcher, MatchResult, levenshtein_distance
...
class TestMatching(unittest.TestCase):
    ...
    def test_match_strategy_a_exact(self):
        ...
        result = self.matcher.match_horse("BLACK SAXON", birth_year=2018, sex="H", country="FR")
    ...
    def test_match_strategy_a_with_accent(self):
        ...
        result = self.matcher.match_horse("Élégant D'Avril", birth_year=2019, sex="M", country="FR")
        self.assertIsNotNone(result.ifce_horse_key)
        self.assertEqual(result.match_stage, "A")

    def test_match_strategy_b_year_only(self):
        """Test matching souple (B) avec année uniquement"""
        result = self.matcher.match_horse("LADY WINNER", birth_year=2019)
        self.assertIsNotNone(result.ifce_horse_key)
    ...
    def test_match_strategy_b_country_only(self):
        ...
        result = self.matcher.match_horse("CHAMPION STAR", country="GB")
        self.assertIsNotNone(result.ifce_horse_key)
        self.assertEqual(result.match_stage, "B")

    def test_match_not_found(self):
        """Test cheval non trouvé"""
        result = self.matcher.match_horse("UNKNOWN HORSE", birth_year=2020, sex="M", country="FR")
