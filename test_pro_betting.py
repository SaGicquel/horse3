...
def test_analyzer():
    ...
    for race_key in race_keys:
        ...
        if not missing:
            print(f"✅ Test 2 - Tous les champs requis présents")
        else:
            print(f"❌ Test 2 - Champs manquants: {missing}")
            all_passed = False
        
        # Test 3: Champs partants
        runner_fields = ["numero", "nom", "p_win", "fair_odds", "value_pct", "kelly_fraction", "rationale"]
        ...
        if runners:
            ...
            if not missing_runner:
                print(f"✅ Test 3 - Tous les champs partant présents")
            else:
        ...
        for r in runners[:3]:  # Vérifier les 3 premiers
            ...
            if p_win and fair_odds:
                ...
                if abs(fair_odds - expected_fair) < 0.1:
                    ...
                    print(f"⚠️ Test 4 - fair_odds incohérent pour {r['nom']}: {fair_odds} vs attendu {expected_fair:.2f}")
        
        print(f"✅ Test 4 - fair_odds cohérents")
        ...
        print(f"✅ Test 5 - Kelly/Value cohérents")
        ...
        print(f"✅ Test 6 - Rationale ≤ 3 éléments")
