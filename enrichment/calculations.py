...
def compute_reduction_km(time_sec: float | None, distance_m: int | None, 
                        reduction_provided: float | None = None) -> float | None:
    """
...
def compute_records(performances: List[Dict]) -> Tuple[Optional[PerformanceRecord], 
