...
class PMUToSchemaAdapter:
    ...
    def get_or_create_cheval(self, cheval_data: dict) -> int:
        ...
        self.cur.execute(
            ...
            RETURNING id_cheval
        """,
            (nom, sexe, an_naissance, robe, origine, nom_pere, nom_mere, proprietaire, eleveur),
        )
    ...
    def get_or_create_personne(
        self, nom: str, type_personne: str, personne_data: dict = None
    ) -> int:
        """
    ...
    def create_course(self, course_data: dict, date_iso: str, reunion: int, course: int) -> str:
        ...
        hippo_data = course_data.get("hippodrome") or course_data.get("reunion", {}).get(
            "hippodrome"
        )
        ...
        nombre_partants = course_data.get("nombreDeclaresPartants") or len(
            course_data.get("participants", [])
        )
    ...
    def create_performance(self, id_course: str, participant_data: dict) -> int:
        ...
        id_entraineur = (
            self.get_or_create_personne(nom_entraineur, "ENTRAINEUR") if nom_entraineur else None
        )
    ...
    def scrape_course(self, date_iso: str, reunion: int, course: int):
        ...
        for base in (BASE, FALLBACK_BASE):
            ...
            if data:
                ...
                perfs_data = fetch_performances(
                    date_iso, reunion, course, self.cur, None, max_hist=20
                )
