...
FEATURES_COLS = [
    'an_naissance', 'distance',
    'nombre_partants', 'temperature_c', 'vent_kmh',
    'nb_courses_12m', 'nb_victoires_12m', 'taux_places_12m', 'regularite',
    'jours_depuis_derniere', 'aptitude_distance', 'aptitude_piste', 'aptitude_hippodrome',
    'taux_victoires_jockey', 'taux_places_jockey', 'taux_victoires_entraineur',
    'taux_places_entraineur', 'synergie_jockey_cheval', 'synergie_entraineur_cheval',
    'distance_norm', 'niveau_moyen_concurrent', 'rang_cote_sp', 'rang_cote_turfbzh',
    'ecart_cote_ia', 'gains_carriere', 'gains_12m', 'gains_par_course',
    'nb_premieres_places', 'nb_deuxiemes_places', 'nb_troisiemes_places',
    'taux_places_carriere', 'gain_moyen_victoire', 'evolution_gains_12m',
    'ratio_gains_courses',
    'aptitude_piste_etat', 'ecart_temp_optimal', 'interaction_piste_meteo',
    'handicap_meteo',
    'interaction_forme_jockey', 'interaction_aptitude_distance',
    'interaction_elo_niveau', 'interaction_cote_ia', 'interaction_synergie_forme',
    'interaction_victoires_jockey', 'popularite_hippodrome',
    'interaction_aptitude_popularite', 'interaction_regularite_volume'
]
