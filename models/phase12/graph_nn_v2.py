...
class EntityGraphNNV2(nn.Module):
    ...
    """
    def __init__(self, metadata, hidden_dim: int = 128, out_dim: int = 1, n_layers: int = 3, dropout: float = 0.2, heads: int = 2):
        """
        Args:
        ...
        for _ in range(n_layers):
            ...
            for edge_type in metadata[1]:
                ...
                conv_dict[edge_type] = GATConv((-1, -1), hidden_dim // heads, heads=heads, add_self_loops=False, dropout=dropout)
    ...
    def forward(self, x_dict, edge_index_dict):
        ...
        for i, conv in enumerate(self.convs):
            ...
            for node_type in x_dict_out:
                ...
                # Dropout
                x_dict_out[node_type] = F.dropout(x_dict_out[node_type], p=self.dropout, training=self.training)
