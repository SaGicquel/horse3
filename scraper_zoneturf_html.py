...
class ScraperZoneTurfHTML:
    ...
    def get_reunions_du_jour(self, date):
        ...
        try:
            ...
            if e.response.status_code == 404:
                print(f"   ⚠️  Aucune réunion pour cette date (404)")
                return []
            else:
    ...
    def scrape_reunion(self, reunion_url):
        ...
        try:
            ...
            if not match:
                print(f"      ❌ Impossible de parser l'URL de la réunion")
                return []
    ...
    def save_to_csv(self, data, output_file):
        ...
        fieldnames = ['Date', 'Hippodrome', 'Reunion', 'Course', 'Num', 'Cheval', 
                      'Musique', 'Corde', 'Ecart', 'Temps', 'CoteDirect', 'CoteRef']
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='data/zoneturf',
