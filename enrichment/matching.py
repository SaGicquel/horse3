...
class HorseMatcher:
    ...
    def _match_strategy_b(
        self, cur: sqlite3.Cursor, name_norm: str, birth_year: Optional[int], country: Optional[str]
    ) -> MatchResult:
        """
    ...
    def _match_strategy_c(self, cur: Any, name_norm: str, birth_year: Optional[int]) -> MatchResult:
        """
