# Manuel de Style - Projet Horse3
- Framework : Next.js 15+ / Tailwind CSS
- UI : Utiliser exclusivement shadcn/ui
- Emplacement composants : src/components/ui
- Règle d'or : Ne JAMAIS écrire de CSS brut. Utilise Tailwind.
- Avant de créer un composant complexe, vérifie si un composant shadcn peut être ajouté via `npx shadcn@latest add [nom]`.
- Utilise les variables CSS du thème (`--background`, `--primary`, etc.) pour les couleurs.
