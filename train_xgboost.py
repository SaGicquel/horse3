...
def evaluate_model(
    model: xgb.XGBClassifier, X: np.ndarray, y: np.ndarray, dataset_name: str = "Validation"
) -> Dict:
    """
...
def plot_feature_importance(
    model: xgb.XGBClassifier, feature_names: list, output_dir: Path, top_n: int = 20
):
    """
...
def plot_roc_curve(
    model: xgb.XGBClassifier, X_val: np.ndarray, y_val: np.ndarray, output_dir: Path
):
    """
    Génère courbe ROC.
