...
class FullDatasetMigrator:
    ...
    def get_or_create_cheval(
        self, nom_norm: str, race: str = None, an_naissance: int = None, sexe: str = None
    ) -> int:
    ...
    def get_or_create_course(
        self, date_course: datetime, hippodrome_id: int, numero_course: int, **course_data
    ) -> int:
    ...
    def migrate_batch(self, limit: int = None, offset: int = 0, year_filter: str = None) -> int:
        ...
        for i, row in enumerate(raw_data):
            try:
                ...
                course_id = self.get_or_create_course(
                    ...
                    allocation_totale=allocation_totale,
                )
                ...
                try:
                    ...
                    """,
                        (
                            ...
                            cote_finale,
                            gains_course,
                            1 if non_partant else 0,
                            1 if disqualifie else 0,
                        ),
                    )
                    migrated_count += 1
    ...
    def migrate_all(self, year_filter: str = None, test_mode: bool = False) -> int:
        ...
        while True:
            ...
            migrated = self.migrate_batch(limit=batch_size, offset=offset, year_filter=year_filter)
