...
def top_performers(limite=10):
    ...
    for i, row in enumerate(cur.fetchall(), 1):
        ...
        print(f"{i:<5} {nom[:24]:<25} {date_naiss or 'N/A':<12} {nb_courses:<8} {nb_victoires:<10} {taux:.1f}%")
...
def chevaux_par_annee(annee):
    ...
    for row in results:
        ...
        print(f"{nom[:29]:<30} {sexe or 'N/A':<6} {(race or 'N/A')[:19]:<20} {nb_courses or 0:<8} {nb_victoires or 0}")
