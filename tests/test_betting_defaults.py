...
KELLY_PROFILES = {"SUR": 0.25, "STANDARD": 0.33, "AMBITIEUX": 0.50, "PERSONNALISE": None}
...
def calculate_stake(bankroll: float, p_win: float, odds: float, config: BettingConfig) -> float:
    """
