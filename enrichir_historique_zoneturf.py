...
def main():
    ...
    parser.add_argument('--days', type=int, default=30,
                       help='Nombre de jours à enrichir (défaut: 30)')
    parser.add_argument('--start-date', type=str,
                       help='Date de départ optionnelle (YYYY-MM-DD)')
        ...
        while current_date <= end_date:
            ...
            try:
                ...
                if enrichisseur.stats['courses_enrichies'] > 0:
                    ...
                    stats_globales['performances_enrichies'] += enrichisseur.stats['performances_enrichies']
                else:
