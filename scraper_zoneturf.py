...
class ZoneTurfScraper:
    ...
    def create_performance(self, id_course: str, data: Dict) -> int:
        ...
        id_jockey = self.get_or_create_personne(
            data.get('nom_jockey'),
            'JOCKEY',
            data.get('code_jockey')
        )
        id_entraineur = self.get_or_create_personne(
            data.get('nom_entraineur'),
            'ENTRAINEUR',
            data.get('code_entraineur')
        )
    ...
    def _parse_performance_from_row(self, row: Dict) -> Dict:
        ...
        return {
            ...
            'numero_corde': self._parse_int(row.get('numero_corde', row.get('numero', row.get('corde')))),
            ...
            'cote_sp': self._parse_float(row.get('cote_sp', row.get('cote_depart', row.get('cote')))),
            'position_arrivee': self._parse_int(row.get('position_arrivee', row.get('position', row.get('place')))),
            'ecart': row.get('ecart'),
