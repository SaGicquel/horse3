...
def main():
    ...
    parser = argparse.ArgumentParser(description="Génère les prédictions XGBoost SAFE sur l'historique")
    parser.add_argument("--batch_size", type=int, default=10000, 
                       help="Taille des batches pour les prédictions")
    parser.add_argument("--output", type=str, default="data/backtest_predictions.csv",
    ...
    try:
        ...
        # 6. Sauvegarde
        logger.info(f"💾 Sauvegarde des prédictions...")
        ...
        logger.info(f"📅 Période couverte: {output_df['date_course'].min()} à {output_df['date_course'].max()}")
