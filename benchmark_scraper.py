...
def main():
    ...
    if nb_courses < 50:
        ...
        print("📈 PROJECTION POUR 100 COURSES:")
        print(
            f"   • Séquentiel:     ~{estimated_100_seq:.0f}s ({estimated_100_seq/60:.1f} minutes)"
        )
        print(
            f"   • Multi-threadé:  ~{estimated_100_thread:.0f}s ({estimated_100_thread/60:.1f} minutes)"
        )
